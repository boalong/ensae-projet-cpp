...
asian_call::asian_call(double spotprice, double strikeprice, double maturity, double volatility, double r) : option(spotprice, strikeprice, maturity, volatility, r) {}

asian_call::~asian_call() {}


double asian_call::price_cont_BSM()
{
...
double asian_call::price_disc_MC(int N_timesteps, int N_simulations)
{
    double sum = 0;
    double S;
    double diff;
