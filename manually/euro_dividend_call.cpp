...
euro_dividend_call::euro_dividend_call(double spotprice, double strikeprice, double maturity,
                                       double volatility, double r, double dividend)
                                       : option(spotprice, strikeprice, maturity, volatility, r), dividend(dividend){}

euro_dividend_call::~euro_dividend_call() {}

double euro_dividend_call::get_dividend() const { return dividend; }

void euro_dividend_call::set_dividend(double newDividend) { dividend = newDividend; }

double euro_dividend_call::price_BSM()
{
...
double euro_dividend_call::price_MC(int N_timesteps, int N_simulations)
{
    double sum = 0;
